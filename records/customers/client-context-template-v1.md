...
*To set up a new client directory:*
1. *Copy this template to `records/customers/[client-name]/[client-name]-client-context-v1.md`*
2. *Create a `transcripts/` subdirectory*
3. *Update `records/customers/INDEX.md`*
